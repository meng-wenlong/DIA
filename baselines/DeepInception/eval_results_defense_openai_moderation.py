...
def main() -> None:
    ...
    if evaluator:
        for rewritten_path in rewritten_paths:
            eval_results = eval_result_with_evaluator(rewritten_path, evaluator, question_column="attack_prompt")
    ...
    for i, rewritten_path in enumerate(rewritten_paths):
        ...
        moderation_results = eval_result_with_evaluator(rewritten_path, moderator, question_column="attack_prompt")
